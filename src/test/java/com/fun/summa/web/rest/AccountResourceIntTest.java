package com.fun.summa.web.rest;

import com.fun.summa.config.Constants;
import com.fun.summa.SummaApp;
import com.fun.summa.domain.Authority;
import com.fun.summa.domain.PersistentToken;
import com.fun.summa.domain.User;
import com.fun.summa.repository.AuthorityRepository;
import com.fun.summa.repository.PersistentTokenRepository;
import com.fun.summa.repository.UserRepository;
import com.fun.summa.security.AuthoritiesConstants;
import com.fun.summa.service.MailService;
import com.fun.summa.service.dto.UserDTO;
import com.fun.summa.web.rest.errors.ExceptionTranslator;
import com.fun.summa.web.rest.vm.KeyAndPasswordVM;
import com.fun.summa.web.rest.vm.ManagedUserVM;
import com.fun.summa.service.UserService;
...
@SpringBootTest(classes = SummaApp.class)
