package com.fun.summa.repository;

import com.fun.summa.SummaApp;
import com.fun.summa.config.Constants;
import com.fun.summa.config.audit.AuditEventConverter;
import com.fun.summa.domain.PersistentAuditEvent;
...
import static com.fun.summa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
